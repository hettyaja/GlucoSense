    ...
    <View style={{flex: 1, backgroundColor: '#ffffff'}}>
      <View style={{backgroundColor:"#E58B68"}}>
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 50 }}>
          <Text style={{ color: 'white', fontFamily: 'Poppins-Bold', fontSize: 16, flex: 1, textAlign: 'center', marginBottom: 10}}>Get your code</Text>
        </View>
      </View>
      ...
      <Text style={{fontFamily: 'Poppins-Medium', fontSize: 14,marginLeft: 30, marginTop: 15}}>Verification Code</Text>
        ...
        <TouchableOpacity style={{ alignItems: 'center', marginTop: 93 }} onPress = {() => router.push('login/reset3')}>
