  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={{flexDirection:'row'}}>
        ...
        <Image source={images.headerQuestion4} resizeMode='contain' style={{width:168, height:7}}/>
        </View>
        <View style={{width:'25%'}}/>
      </View>
      <Text style={{fontFamily:"Poppins-SemiBold", fontSize: 24, paddingLeft: 60, paddingTop: 60, paddingRight: 80}}>How often do you measure your blood sugar?</Text>
      <View style={{ flexDirection: 'row', justifyContent: 'space-around', paddingTop: 50 }}>
        <View style={styles.container}>
          ...
          >
            <Text style={styles.buttonText}>Twice a day</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
          ...
          >
            <Text style={styles.buttonText}>More than twice a day</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
          ...
          >
            <Text style={styles.buttonText}>I use a CGM</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[
              styles.button,
          ...
          >
            <Text style={styles.buttonText}>I don't measure my blood sugar</Text>
          </TouchableOpacity>
        </View>
      </View>
