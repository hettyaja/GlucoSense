...
const BusinessPartnerDietPlanOrderDetails = () => {
    ...
    <>
      ...
      <ScrollView style={styles.container}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.value}>Start Date: {startDate.toLocaleString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</Text>
          <Text style={styles.value}>End Date: {endDate.toLocaleString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</Text>
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.partnerName}>{order.businessPartnerName}</Text>
          <Text style={styles.planName}>{order.dietPlanName} ({order.quantity} Week)</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.planName}>Total: ${order.totalPayment}</Text>
        </View>
      </ScrollView>
    </>
  );
...
export default BusinessPartnerDietPlanOrderDetails;
